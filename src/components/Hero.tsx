...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100">
            ...
            <div className="container mx-auto px-4 py-32 pb-20 relative z-10">
                    ...
                    <div className={`lg:col-span-5 space-y-8 transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 pt-4 items-center sm:items-start">
                            <a
                                ...
                                className="group relative inline-flex items-center justify-center gap-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-8 sm:px-6 py-4 sm:py-5 rounded-2xl font-bold text-base sm:text-lg shadow-2xl hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden max-w-fit"
                            >
                                {/* Анимированный фон */}
                                ...
                                <span className="relative z-10 whitespace-nowrap">{t.hero.cta1}</span>
                            ...
                            <button
                                ...
                                className="group inline-flex items-center justify-center gap-2 bg-white text-gray-900 px-8 sm:px-6 py-4 sm:py-5 rounded-2xl font-bold text-base sm:text-lg shadow-xl hover:shadow-2xl border-2 border-gray-200 hover:border-slate-800 transition-all duration-300 max-w-fit"
                            >
