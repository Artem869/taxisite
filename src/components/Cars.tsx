                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500 font-medium">{t.cars.monza.type}</p>
                                    </div>
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500 font-medium">{t.cars.seltos.type}</p>
                                    </div>
                                    <div className="text-right">
                                ...
                                <div className="sticky top-0 bg-white border-b border-gray-200 p-6 z-10">
                                    ...
                                    <div className="mt-6 bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-6 text-white">
                                        ...
                                        <a
                                            ...
                                            className="w-full bg-white hover:bg-slate-50 text-green-600 px-6 py-3 rounded-xl font-bold transition-all hover:scale-105 flex items-center justify-center gap-2 shadow-md"
                                        >
