            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
                    >
                        ...
                        <span>{t.advantages.cta.button}</span>
                    </a>
                </div>
            </div>
        </section>
