                    ...
                    <nav className="flex items-center justify-between h-20">
                        ...
                        <div className="hidden lg:block">
                            <a
                                ...
                                className="relative inline-flex items-center gap-2 bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden group"
                            >
                        ...
                        <div className="pt-4 border-t border-gray-200 space-y-3">
                            ...
                            <div className="pt-3 mt-3 border-t border-gray-200 space-y-3">
                                ...
                                <a
                                    ...
                                    className="flex items-center gap-3 px-4 py-4 bg-slate-900 hover:bg-slate-800 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl"
                                >
                                    ...
                                    <div className="flex-1">
                                        <div className="text-xs text-slate-400 mb-1">{language === 'ru' ? 'Позвонить' : 'Қоңырау шалу'}</div>
                                        <div className="text-white font-bold">{t.header.phone}</div>
                                    </div>
                                </a>
